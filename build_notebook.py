...
> **How this notebook demos it:** we measure the *mechanism*, not the output. We plot the
> model's probability of **beginning a refusal** before and after ablation. We never
> print an ablated completion to a harmful prompt. The point here is how shallow the
> safety property is — that point is made better by a collapsing bar chart than by a
> wall of text.
""")
